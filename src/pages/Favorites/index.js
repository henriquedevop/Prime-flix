...
function Favorites() {
    ...
    return(
        <div className="userListMovies">
            ...
            {movies.length === 0 && <span>Você não possui nenhum filme cadastrado :( <Link to={"/"}>Volte para o inicio</Link> </span>}
                    ...
                    return(
                        <li key={movie.id}>
                            ...
                            <div>
                                ...
                                <button className="btn-remove" onClick={() => removeMovie(movie.id)}>Excluir</button>
                            </div>
                        </li>
                    )
                })}   
